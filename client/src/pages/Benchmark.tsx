...
export default function Benchmark() {
  ...
  return (
    <Layout>
      ...
      <meta
        name="description"
        content="Standardised KPIs, process-level measurement and peer comparison for AI transformation. Opens November 2026. Join the waiting list."
      />
      ...
      <section className="bg-white py-16 border-t border-ec-line">
        <div className="container max-w-4xl">
          ...
          <p className="border-l-[3px] border-ec-red pl-[18px] text-ec-body-strong max-w-2xl">
            We run around twelve audits a year. Q3 is full. November seats are open, and the
        ...
        <div className="container max-w-4xl grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-ec-body">
              Benchmark updates only. You hear first when November seats open. No spam,
              unsubscribe anytime.
            </p>
          </div>
          <WaitlistForm />
